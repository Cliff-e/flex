...
export const APP_IDS = {
    ...
    STAGING_ME:   _APP_ID,
    PRODUCTION:   _APP_ID,
    PRODUCTION_BE: _APP_ID,
    PRODUCTION_ME: _APP_ID,
};
...
export const domain_app_ids = {
    ...
    'flex-api-server.vercel.app': APP_IDS.PRODUCTION,
};
...
export const getAppId = () => {
    // Prefer the build-time env var so custom deployments can set their own Deriv app ID
    // without touching localStorage or relying on domain-based mapping.
