...
export default class TicksService {
    ...
    requestTicks(options) {
        ...
        // Guard: 'na' was the legacy placeholder; also block the string 'undefined'
        // which can appear when the market block hasn't been populated yet.
        const safe_symbol = (symbol && symbol !== 'na' && symbol !== 'undefined') ? symbol : 'R_100';
        const request_object = {
            ticks_history: safe_symbol,
            subscribe: 1,
            end: 'latest',
            count: 1000,
